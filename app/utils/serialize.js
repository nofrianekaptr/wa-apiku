const { downloadContentFromMessage, getContentType, getDevice, isJidBroadcast, isJidGroup, jidNormalizedUser, toBuffer } = require("@whiskeysockets/baileys");
...
class Serialize {
    ...
    async serial(client, msg) {
        ...
        m.typeMessage = m.isMedia.isImage ? "image" : m.isMedia.isVideo ? "video" : m.isMedia.isAudio ? "audio" : m.isMedia.isSticker ? "sticker" : m.isMedia.isContact ? "contact" : m.isMedia.isLocation ? "location" : "text";
